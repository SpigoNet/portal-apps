    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                <form action="{{ route('ant.admin.alunos.index') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <select name="materia_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="w-full md:w-auto">
                        <button type="submit" class="w-full bg-indigo-600 text-white px-6 py-2 rounded hover:bg-indigo-700 shadow font-bold">
                            Filtrar
                        </button>
                    </div>
                </form>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                @if($filtroMateria)
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                        ...
                        <a href="{{ route('ant.admin.alunos.importar') }}" class="text-sm text-indigo-600 hover:underline">Importar mais alunos</a>
                    </div>
                        ...
                        @forelse($alunos as $aluno)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <form action="{{ route('ant.admin.alunos.destroy', $aluno->matricula_id) }}" method="POST" onsubmit="return confirm('Tem certeza? O aluno será removido desta disciplina.');">
                                        @csrf
                                        @method('DELETE')
