                ...
                @foreach($materias as $materia)
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-4 pt-3 border-t border-gray-100 flex flex-wrap justify-end gap-4">
                                <a href="{{ route('ant.apresentacoes.aluno.index', ['materia_id' => $materia->id]) }}"
                                    class="text-indigo-600 hover:text-indigo-900 text-sm font-medium flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M7 4v16M3 8h4M3 16h4M15 4h6v4h-6V4zm0 0v16m0-16h-4m4 16h-4m4-16v4m0 12v-4" />
                                    </svg>
                                    Minhas Apresentações
                                </a>
                                <a href="{{ route('ant.apresentacoes.aluno.rank', $materia->id) }}"
                                    class="text-yellow-600 hover:text-yellow-900 text-sm font-medium flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
