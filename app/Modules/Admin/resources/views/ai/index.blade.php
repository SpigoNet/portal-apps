                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="py-3">
                                        ...
                                        <div class="text-xs text-gray-500 flex items-center gap-2">
                                            ...
                                            @if ($p->api_key)
                                                <span
                                                    class="text-[10px] bg-green-100 text-green-700 px-1.5 py-0.5 rounded border border-green-200"
                                                    title="Token Configurado">
                                                    <i class="fa-solid fa-key text-[8px]"></i> Configurado
                                                </span>
                                            @else
                                                <span
                                                    class="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded border border-gray-200"
                                                    title="Sem Token">
                                                    <i class="fa-solid fa-key-skeleton text-[8px]"></i> Sem Token
                                                </span>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-3 text-right">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <form action="{{ route('admin.ai.provedores.destroy', $p) }}"
                                ...
                                <div class="border dark:border-gray-700 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex justify-between items-start mb-2">
                                        <span
                                            ...
                                            {{ $mp->input_type }} <i
                                                class="fa-solid fa-arrow-right mx-1 text-[10px]"></i>
                                            {{ $mp->output_type }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="text-xs text-gray-500 mt-1">
                                        Provedor: <span
                                            class="font-medium text-gray-700 dark:text-gray-300">{{ $mp->modelo->provedor->nome }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
