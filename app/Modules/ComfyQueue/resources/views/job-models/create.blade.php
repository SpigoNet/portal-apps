<x-app-layout>
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('comfy-queue.job-models.store') }}" method="POST">
                @csrf
                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-6">
                    <div class="mb-6">
                        ...
                        <input type="text" name="nome" id="nome" required
                            ...
                            placeholder="Ex: txt2img" value="{{ old('nome') }}">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="json" id="json" rows="20" required
                            class="w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 font-mono text-xs"
                            placeholder='{
  "nome": "__nome__",
  "idade": 30,
  "ativo": true
