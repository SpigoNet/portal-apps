        ...
        <div class="mithril-theme-surface rounded-2xl border border-white/5 overflow-hidden">
            <div class="p-6">
                <form method="GET" action="{{ route('mithril.lancamentos.index') }}"
                    ...
                    <button type="submit" class="btn-elf text-white bg-mithril-primary/20 px-5 py-2.5 rounded-full">
                        <i class="fa-solid fa-filter mr-2"></i>
                        Filtrar
                    </button>
                    
                    <button type="button" id="toggle-efetivados-btn" class="btn-elf text-white bg-black/20 px-5 py-2.5 rounded-full"
