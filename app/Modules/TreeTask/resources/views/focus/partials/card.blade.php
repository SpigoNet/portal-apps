<div class="p-4 hover:bg-gray-50 transition duration-150 ease-in-out flex items-center justify-between group">
    ...
    <div class="flex-1 min-w-0 pr-4">
        <a href="{{ route('treetask.tarefas.edit', $tarefa->id_tarefa) }}" class="block focus:outline-none">
    ...
    <div class="flex items-center space-x-4">
        ...
        <a href="{{ route('treetask.tarefas.edit', $tarefa->id_tarefa) }}" class="text-gray-400 hover:text-blue-600 p-2 rounded-full hover:bg-blue-50">
